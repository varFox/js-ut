...
//      '#2 Установка spikmi и работа с ветками на Github | Марафон вёрстки Урок 2 | Установка spikmi и работа с ветками на Github',
...
function load() {
  gapi.client.init({
    'apiKey': 'AIzaSyAcBlpKvUzvvP_ysPTWb7Pw1A6MXxqPW64',
    ...
    sliceTitle('.video__item-descr', 100);
